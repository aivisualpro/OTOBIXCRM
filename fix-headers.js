...
const salesFiles = [
  'all.vue', 'customer-activity.vue', 'customers.vue', 'dealer-activity.vue', 'ended.vue', 
  'invoices.vue', 'live.vue', 'orders.vue', 'otobuy.vue', 'products.vue', 'quotes.vue', 
  'removed.vue', 'sold.vue', 'upcoming.vue'
].map(f => `app/pages/sales/${f}`);

const retailFiles = [
  'all.vue', 'customer-activity.vue', 'customers.vue', 'dealer-activity.vue', 'ended.vue', 
  'invoices.vue', 'live.vue', 'orders.vue', 'otobuy.vue', 'pickup-requests.vue', 
  'products.vue', 'purchase-requests.vue', 'quotes.vue', 'removed.vue', 'sold.vue', 'upcoming.vue'
...
function processFile(filePath, isRetail) {
  ...
  content = content.replace(/title="([^"]+)"/g, (match, title) => {
    ...
    if (!newTitle.includes(prefix)) {
      if (newTitle === "Sales") newTitle = "All"; // if it was just "Sales", call it "All"
