...
export const routeColumnsMap: Record<string, any[]> = {
  'quality-rejected': [
    { key: 'appointmentId', label: 'Appt. ID' },
    { key: 'ownerName', label: 'Owner Name' },
    { key: 'customerContactNumber', label: 'Contact Number' },
    ...
    { key: 'model', label: 'Model' },
    { key: 'variant', label: 'Variant' },
    { key: 'yearOfManufacture', label: 'mfg Year' },
    { key: 'yearOfRegistration', label: 'Reg Year' },
    { key: 'ownershipSerialNumber', label: 'Owner', type: 'number' },
    { key: 'registrationNumber', label: 'Reg. No.' },
    { key: 'vehicleStatus', label: 'Vehicle Status' },
    { key: 'city', label: 'City' },
    { key: 'timestamp', label: 'Inspection At', type: 'date' },
    { key: 'appointmentSource', label: 'Source' },
    { key: 'inspectionStatus', label: 'Inspection Status', type: 'badge' },
  ...
  'under-review': [
    ...
    { key: 'yearOfManufacture', label: 'mfg Year' },
    { key: 'yearOfRegistration', label: 'Reg Year' },
    { key: 'odometerReadingInKms', label: 'Odometer', type: 'number' },
    { key: 'registrationNumber', label: 'Reg. No.' },
    { key: 'vehicleStatus', label: 'Vehicle Status' },
    { key: 'city', label: 'City' },
    { key: 'timestamp', label: 'Inspection At', type: 'date' },
  ...
  're-inspection': [
    ...
    { key: 'city', label: 'City' },
    { key: 'inspectionAddress', label: 'Address' },
    { key: 'inspectionDateTime', label: 'Scheduled At', type: 'date' },
    { key: 'appointmentSource', label: 'Source' },
    { key: 'inspectionStatus', label: 'Inspection Status', type: 'badge' },
    { key: 'priority', label: 'Priority', type: 'badge' },
    { key: 'allocatedTo', label: 'Inspected By' },
...
export const routeFilters = {
  ...
  'quality-rejected': { label: 'Quality Rejected', inspectionStatus: '*', approvalStatus: 'Quality Rejected' },
