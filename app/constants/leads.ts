export const leadsColumns = [
  ...
  { key: 'carRegistrationNumber', label: 'Reg. Number' },
  { key: 'make', label: 'Make' },
  ...
  { key: 'inspectionDate', label: 'Inspection Date', type: 'date' as const },
