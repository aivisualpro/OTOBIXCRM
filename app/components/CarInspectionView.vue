...
const exteriorSections = [
  ...
  },
  {
    ...
    imageKeys: [
      ...
      { new: 'bootDoorClosedImages', old: 'rearWithBootDoorOpen' },
    ...
    parts: [
      ...
      { key: 'rearWindshieldDropdownList', oldKey: 'rearWindshield', imageKey: 'rearWindshieldImages', oldImageKey: 'rearWindshieldImages', label: 'Rear Windshield' },
      {
        ...
        label: 'Boot Door',
        imageGroups: [
          { key: 'bootDoorOpenImages', oldKey: 'rearWithBootDoorOpen', label: 'Boot Door Open' },
          { key: 'bootDoorClosedImages', oldKey: 'rearWithBootDoorOpen', label: 'Boot Door Closed' },
        ],
      },
