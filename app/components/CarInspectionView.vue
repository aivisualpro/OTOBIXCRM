...
const engineParts = [
  ...
  { key: 'split_7', hasNoImages: true, splitParts: [ { key: 'radiatorSupportDropdownList', oldKey: 'radiatorSupport', label: 'Radiator Support', dropdownName: 'Radiator Support' }, { key: 'commentsOnRadiatorDropdownList', oldKey: 'commentsOnRadiator', label: 'Comment on Radiator', dropdownName: 'Comment on Radiator' } ] },
  ...
  { key: 'split_9', hasNoImages: true, splitParts: [ { key: 'commentsOnTowingDropdownList', oldKey: 'commentsOnTowing', label: 'Comment on Towing', dropdownName: 'Comment on Towing' }, { key: 'commentsOnOthersDropdownList', oldKey: 'commentsOnOthers', label: 'Comment on Others', dropdownName: 'Comment on Others' } ] },
]
