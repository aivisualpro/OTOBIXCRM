          ...
          <div class="rounded-2xl border bg-gradient-to-br from-muted/30 to-muted/50 overflow-hidden">
            ...
            <div class="p-3 flex items-center justify-between">
              ...
              <div class="flex items-center gap-1.5">
                <Badge variant="outline" class="text-[9px] capitalize" :class="typeColor(addForm.type)">
                  {{ addForm.type }}
                </Badge>
                <Badge variant="secondary" class="text-[9px] capitalize">
                  {{ addForm.view }}
                </Badge>
                <Badge variant="outline" class="text-[9px] capitalize" :class="statusColor(addForm.status)">
                  {{ addForm.status }}
                </Badge>
              </div>
            </div>
...
</style>.includes(a) ? 999 : order.indexOf(a)) - (!order.indexOf(b) === -1 ? 999 : order.indexOf(b))
  })
})
...
</style>.includes(b) ? 999 : order.indexOf(b))
  })
})
