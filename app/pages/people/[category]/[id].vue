...
const roleOptions = ['Admin', 'Staff', 'KAM', 'Inspector', 'Operations', 'Dealer', 'Customer']
  ...
  <div class="w-full h-full overflow-auto">
    ...
    <div v-if="!user" class="flex items-center justify-center h-64 text-muted-foreground">
      <div class="flex flex-col items-center gap-3">
        ...
        <p class="text-sm">Loading user profile...</p>
      </div>
    </div>
        ...
        <div class="px-6 -mt-10 pb-6 relative z-10">
          <div class="flex items-end gap-5">
            ...
            <div class="pb-1 flex-1 min-w-0">
              <h2 class="text-xl font-bold truncate">{{ user.userName || '—' }}</h2>
      ...
      <template v-if="!isEditing">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="rounded-xl border bg-card p-4 space-y-2">
            ...
            <p class="text-sm font-medium pl-10">{{ user.email || '—' }}</p>
          </div>
          ...
          <div class="rounded-xl border bg-card p-4 space-y-2">
            ...
            <p class="text-sm font-medium pl-10 font-mono">{{ user.phoneNumber || '—' }}</p>
          </div>
          ...
          <div v-if="user.dealershipName" class="rounded-xl border bg-card p-4 space-y-2">
            ...
            <p class="text-sm font-medium pl-10">{{ user.dealershipName }}</p>
          </div>
          ...
          <div v-if="user.assignedKam" class="rounded-xl border bg-card p-4 space-y-2">
            ...
            <p class="text-sm font-medium pl-10">{{ user.assignedKam }}</p>
          </div>
          ...
          <div v-if="user.entityType" class="rounded-xl border bg-card p-4 space-y-2">
            ...
            <p class="text-sm font-medium pl-10">{{ user.entityType }}</p>
          </div>
        </div>
        ...
        <div v-if="user.primaryContactPerson || user.secondaryContactPerson" class="rounded-xl border bg-card p-5 space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div v-if="user.primaryContactPerson" class="rounded-lg bg-muted/30 border p-3 space-y-1">
              ...
              <p class="text-sm font-medium">{{ user.primaryContactPerson }}</p>
              <p v-if="user.primaryContactNumber" class="text-xs text-muted-foreground font-mono">{{ user.primaryContactNumber }}</p>
            </div>
            <div v-if="user.secondaryContactPerson" class="rounded-lg bg-muted/30 border p-3 space-y-1">
              ...
              <p class="text-sm font-medium">{{ user.secondaryContactPerson }}</p>
              <p v-if="user.secondaryContactNumber" class="text-xs text-muted-foreground font-mono">{{ user.secondaryContactNumber }}</p>
            </div>
          </div>
        </div>
        ...
        <div class="rounded-xl border bg-card p-6 space-y-5">
          ...
          <div class="flex items-center justify-between rounded-lg border p-4">
            <div>
              ...
              <p class="text-xs text-muted-foreground mt-0.5">Mark this user as Otobix staff (isStaff=true)</p>
            </div>
